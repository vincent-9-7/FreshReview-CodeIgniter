  ...
  <div class="container">
    ...
    <div class="row justify-content-around">
                  ...
                  if (response == "" ) {
                    ...
                    if(obj.length>0){
                      ...
                      $.each(obj, function(i,val){
                        ...
                        const button2 = '<button type="button" class="btn btn-primary m-auto"  onclick="location.href=\'<?php echo base_url(); ?>UserItemList/show_review_func?'+val.itemName+'\'">'+'Find the Review'+'</button>';                    
                        const button3 = '<button type="button" class="btn btn-primary m-auto"  onclick="location.href=\'<?php echo base_url(); ?>UserItemList/download_pdf_func?'+val.itemName+'\'">'+'Download the pdf'+'</button>';                    
      ...
      <a class="btn btn-primary mb-5" href="<?php echo base_url();?>NearbyStore">Find nearby Store</a>
